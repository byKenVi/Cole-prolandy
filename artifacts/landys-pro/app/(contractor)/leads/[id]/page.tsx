      ...
      <div className="grid items-start gap-7 lg:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <div className="order-2 overflow-hidden rounded-[22px] border border-[#EBE3D4] bg-[#FFFDF9] shadow-[0_12px_32px_rgba(58,53,45,0.08)] lg:order-1">
          <div className="px-8 pb-8 pt-7">
            ...
            <div className="my-6 flex flex-wrap gap-2.5">
              ...
              {actionable && (
                <ExpiryCountdown expiresAt={lead.expiresAt} variant="prominent" />
              )}
              {expired && (
        ...
        <div className="order-1 rounded-[20px] border border-[#EBE3D4] bg-[#FFFDF9] p-6 shadow-[0_12px_32px_rgba(58,53,45,0.10)] lg:order-2 lg:sticky lg:top-6">
          ...
          {accepted ? (
            ...
            /* Actionable — LeadActions handles both sufficient and insufficient balance,
               opening an inline top-up dialog when funds are low. */
            <LeadActions
              matchId={match.id}
              priceCents={lead.priceCents}
              balanceCents={contractor.walletBalanceCents}
